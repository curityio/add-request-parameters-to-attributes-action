RequestParametersToAttributes Authentication Action Plugin
=============================================
...
To install the plugin, copy the compiled JAR (and all of its dependencies) into the :file:`${IDSVR_HOME}/usr/share/plugins/RequestParametersToAttributes`
